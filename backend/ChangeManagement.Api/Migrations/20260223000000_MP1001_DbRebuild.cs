...
<<<<<<< codex/stabilize-solution-and-align-schema-62sg0u
        // =============================================
        ...
        // =============================================
        // 2. SEQUENCE FOR ChangeNumber (auto-increment)
        // =============================================
        ...
        // =============================================
        // 5. INDEXES (performance + uniqueness)
        // =============================================
...
=======
        ...
        migrationBuilder.CreateTable(name: "ChangeStatus", schema: "ref", columns: table => new { StatusId = table.Column<int>("int", nullable: false), Name = table.Column<string>("nvarchar(100)", maxLength: 100, nullable: false), IsTerminal = table.Column<bool>("bit", nullable: false) }, constraints: table => table.PrimaryKey("PK_ChangeStatus", x => x.StatusId));
        migrationBuilder.CreateTable(name: "RiskLevel", schema: "ref", columns: table => new { RiskLevelId = table.Column<int>("int", nullable: false), Name = table.Column<string>("nvarchar(100)", maxLength: 100, nullable: false), Score = table.Column<int>("int", nullable: false) }, constraints: table => table.PrimaryKey("PK_RiskLevel", x => x.RiskLevelId));
        migrationBuilder.CreateTable(name: "ImpactLevel", schema: "ref", columns: table => new { ImpactLevelId = table.Column<int>("int", nullable: false), Name = table.Column<string>("nvarchar(100)", maxLength: 100, nullable: false), Score = table.Column<int>("int", nullable: false) }, constraints: table => table.PrimaryKey("PK_ImpactLevel", x => x.ImpactLevelId));
        migrationBuilder.CreateTable(name: "ImpactType", schema: "ref", columns: table => new { ImpactTypeId = table.Column<int>("int", nullable: false), Name = table.Column<string>("nvarchar(100)", maxLength: 100, nullable: false), Description = table.Column<string>("nvarchar(300)", maxLength: 300, nullable: true) }, constraints: table => table.PrimaryKey("PK_ImpactType", x => x.ImpactTypeId));

        // 2. RAW SQL SEEDING (bypasses entity mapping requirement)
        migrationBuilder.Sql("INSERT INTO [ref].[ChangeType] (ChangeTypeId, Name, Description) VALUES (1,'Standard','Pre-approved low-risk changes'),(2,'Normal','Standard changes requiring approval'),(3,'Emergency','Urgent changes to restore service');");
        migrationBuilder.Sql("INSERT INTO [ref].[ChangePriority] (PriorityId, Name, SortOrder) VALUES (1,'Critical',1),(2,'High',2),(3,'Medium',3),(4,'Low',4);");
        migrationBuilder.Sql("INSERT INTO [ref].[ChangeStatus] (StatusId, Name, IsTerminal) VALUES (1,'Draft',0),(2,'Submitted',0),(3,'In Review',0),(4,'Approved',0),(5,'Scheduled',0),(6,'In Progress',0),(7,'Implemented',1),(8,'Closed',1),(9,'Rejected',1),(10,'Failed',1);");
        migrationBuilder.Sql("INSERT INTO [ref].[RiskLevel] (RiskLevelId, Name, Score) VALUES (1,'Low',1),(2,'Medium',3),(3,'High',5),(4,'Critical',10);");
        migrationBuilder.Sql("INSERT INTO [ref].[ImpactLevel] (ImpactLevelId, Name, Score) VALUES (1,'Very Low',1),(2,'Low',2),(3,'Medium',3),(4,'High',4),(5,'Very High',5);");
        migrationBuilder.Sql("INSERT INTO [ref].[ImpactType] (ImpactTypeId, Name, Description) VALUES (1,'Operational','Impact on day-to-day operations'),(2,'Financial','Financial or budget impact'),(3,'Customer','Customer-facing service impact'),(4,'Regulatory','Compliance or regulatory impact'),(5,'Technical','Purely technical/system impact');");

        migrationBuilder.CreateSequence<int>(name: "ChangeNumberSeq", schema: "cm", startValue: 10001, incrementBy: 1, minValue: 10001);

        // 3. User table
        migrationBuilder.CreateTable(name: "User", schema: "cm", columns: table => new { UserId = table.Column<Guid>("uniqueidentifier", nullable: false), Upn = table.Column<string>("nvarchar(256)", maxLength: 256, nullable: false), DisplayName = table.Column<string>("nvarchar(200)", maxLength: 200, nullable: false), PasswordHash = table.Column<string>("nvarchar(max)", nullable: false), Role = table.Column<string>("nvarchar(50)", maxLength: 50, nullable: false), IsActive = table.Column<bool>("bit", nullable: false, defaultValue: true), CreatedAt = table.Column<DateTime>("datetime2", nullable: false, defaultValueSql: "GETUTCDATE()") }, constraints: table => table.PrimaryKey("PK_User", x => x.UserId));

        // 4. ChangeRequest (full definition with all FKs)
        migrationBuilder.CreateTable(name: "ChangeRequest", schema: "cm", columns: table => new { ChangeRequestId = table.Column<Guid>("uniqueidentifier", nullable: false), ChangeNumber = table.Column<int>("int", nullable: false, defaultValueSql: "NEXT VALUE FOR cm.ChangeNumberSeq"), Title = table.Column<string>("nvarchar(300)", maxLength: 300, nullable: false), Description = table.Column<string>("nvarchar(max)", nullable: true), ChangeTypeId = table.Column<int>("int", nullable: false), PriorityId = table.Column<int>("int", nullable: false), StatusId = table.Column<int>("int", nullable: false), RiskLevelId = table.Column<int>("int", nullable: false), RequestedByUserId = table.Column<Guid>("uniqueidentifier", nullable: false), AssignedToUserId = table.Column<Guid>("uniqueidentifier", nullable: true), PlannedStart = table.Column<DateTime>("datetime2", nullable: true), PlannedEnd = table.Column<DateTime>("datetime2", nullable: true), ActualStart = table.Column<DateTime>("datetime2", nullable: true), ActualEnd = table.Column<DateTime>("datetime2", nullable: true), ImplementationSteps = table.Column<string>("nvarchar(max)", nullable: true), BackoutPlan = table.Column<string>("nvarchar(max)", nullable: true), BusinessJustification = table.Column<string>("nvarchar(max)", nullable: true), Category = table.Column<string>("nvarchar(200)", maxLength: 200, nullable: true), Environment = table.Column<string>("nvarchar(200)", maxLength: 200, nullable: true), ServiceSystem = table.Column<string>("nvarchar(200)", maxLength: 200, nullable: true), ImplementationGroup = table.Column<string>("nvarchar(200)", maxLength: 200, nullable: true), ImpactLevelId = table.Column<int>("int", nullable: true), ImpactTypeId = table.Column<int>("int", nullable: true), ApprovalRequired = table.Column<bool>("bit", nullable: false, defaultValue: false), ApprovalStrategy = table.Column<string>("nvarchar(50)", maxLength: 50, nullable: true), ApprovalRequesterUserId = table.Column<Guid>("uniqueidentifier", nullable: true), SubmittedAt = table.Column<DateTime>("datetime2", nullable: true), SubmittedByUserId = table.Column<Guid>("uniqueidentifier", nullable: true), DeletedAt = table.Column<DateTime>("datetime2", nullable: true), DeletedByUserId = table.Column<Guid>("uniqueidentifier", nullable: true), DeletedReason = table.Column<string>("nvarchar(400)", maxLength: 400, nullable: true), CreatedAt = table.Column<DateTime>("datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"), CreatedBy = table.Column<Guid>("uniqueidentifier", nullable: false), UpdatedAt = table.Column<DateTime>("datetime2", nullable: true), UpdatedBy = table.Column<Guid>("uniqueidentifier", nullable: true) }, constraints: table =>
        {
            table.PrimaryKey("PK_ChangeRequest", x => x.ChangeRequestId);
            table.ForeignKey("FK_ChangeRequest_ChangeType", x => x.ChangeTypeId, "ChangeType", "ChangeTypeId", "ref", onDelete: ReferentialAction.Restrict);
            table.ForeignKey("FK_ChangeRequest_ChangePriority", x => x.PriorityId, "ChangePriority", "PriorityId", "ref", onDelete: ReferentialAction.Restrict);
        ...
        // 5. Child tables (ChangeApprover, ChangeAttachment, ChangeTask, ChangeTemplate, EventType, AuditEvent)
        migrationBuilder.CreateTable(name: "ChangeApprover", schema: "cm", columns: table => new { ChangeApproverId = table.Column<Guid>("uniqueidentifier", nullable: false), ChangeRequestId = table.Column<Guid>("uniqueidentifier", nullable: false), ApproverUserId = table.Column<Guid>("uniqueidentifier", nullable: false), ApprovalStatus = table.Column<string>("nvarchar(50)", maxLength: 50, nullable: false), DecisionAt = table.Column<DateTime>("datetime2", nullable: true), DecisionComments = table.Column<string>("nvarchar(max)", nullable: true), CreatedAt = table.Column<DateTime>("datetime2", nullable: false, defaultValueSql: "GETUTCDATE()") }, constraints: table => { table.PrimaryKey("PK_ChangeApprover", x => x.ChangeApproverId); table.ForeignKey("FK_ChangeApprover_ChangeRequest", x => x.ChangeRequestId, "ChangeRequest", "ChangeRequestId", "cm", onDelete: ReferentialAction.Cascade); table.ForeignKey("FK_ChangeApprover_User", x => x.ApproverUserId, "User", "UserId", "cm", onDelete: ReferentialAction.Restrict); });
        migrationBuilder.CreateTable(name: "ChangeAttachment", schema: "cm", columns: table => new { ChangeAttachmentId = table.Column<Guid>("uniqueidentifier", nullable: false), ChangeRequestId = table.Column<Guid>("uniqueidentifier", nullable: false), FileName = table.Column<string>("nvarchar(300)", maxLength: 300, nullable: false), FilePath = table.Column<string>("nvarchar(500)", maxLength: 500, nullable: false), FileSizeBytes = table.Column<long>("bigint", nullable: false), UploadedAt = table.Column<DateTime>("datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"), UploadedBy = table.Column<Guid>("uniqueidentifier", nullable: true) }, constraints: table => { table.PrimaryKey("PK_ChangeAttachment", x => x.ChangeAttachmentId); table.ForeignKey("FK_ChangeAttachment_ChangeRequest", x => x.ChangeRequestId, "ChangeRequest", "ChangeRequestId", "cm", onDelete: ReferentialAction.Cascade); table.ForeignKey("FK_ChangeAttachment_User", x => x.UploadedBy, "User", "UserId", "cm", onDelete: ReferentialAction.Restrict); });
        migrationBuilder.CreateTable(name: "ChangeTask", schema: "cm", columns: table => new { ChangeTaskId = table.Column<Guid>("uniqueidentifier", nullable: false), ChangeRequestId = table.Column<Guid>("uniqueidentifier", nullable: false), Title = table.Column<string>("nvarchar(300)", maxLength: 300, nullable: false), Description = table.Column<string>("nvarchar(max)", nullable: true), AssignedToUserId = table.Column<Guid>("uniqueidentifier", nullable: true), Status = table.Column<string>("nvarchar(50)", maxLength: 50, nullable: false), DueDate = table.Column<DateTime>("datetime2", nullable: true), CompletedAt = table.Column<DateTime>("datetime2", nullable: true), CreatedAt = table.Column<DateTime>("datetime2", nullable: false, defaultValueSql: "GETUTCDATE()") }, constraints: table => { table.PrimaryKey("PK_ChangeTask", x => x.ChangeTaskId); table.ForeignKey("FK_ChangeTask_ChangeRequest", x => x.ChangeRequestId, "ChangeRequest", "ChangeRequestId", "cm", onDelete: ReferentialAction.Cascade); table.ForeignKey("FK_ChangeTask_User", x => x.AssignedToUserId, "User", "UserId", "cm", onDelete: ReferentialAction.Restrict); });
        migrationBuilder.CreateTable(name: "ChangeTemplate", schema: "cm", columns: table => new { TemplateId = table.Column<Guid>("uniqueidentifier", nullable: false), Name = table.Column<string>("nvarchar(200)", maxLength: 200, nullable: false), Description = table.Column<string>("nvarchar(max)", nullable: true), ImplementationSteps = table.Column<string>("nvarchar(max)", nullable: true), BackoutPlan = table.Column<string>("nvarchar(max)", nullable: true), ServiceSystem = table.Column<string>("nvarchar(200)", maxLength: 200, nullable: true), Category = table.Column<string>("nvarchar(200)", maxLength: 200, nullable: true), Environment = table.Column<string>("nvarchar(200)", maxLength: 200, nullable: true), ChangeTypeId = table.Column<int>("int", nullable: true), RiskLevelId = table.Column<int>("int", nullable: true), IsActive = table.Column<bool>("bit", nullable: false, defaultValue: true), CreatedAt = table.Column<DateTime>("datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"), CreatedBy = table.Column<Guid>("uniqueidentifier", nullable: false) }, constraints: table => { table.PrimaryKey("PK_ChangeTemplate", x => x.TemplateId); table.ForeignKey("FK_ChangeTemplate_ChangeType", x => x.ChangeTypeId, "ChangeType", "ChangeTypeId", "ref", onDelete: ReferentialAction.Restrict); table.ForeignKey("FK_ChangeTemplate_RiskLevel", x => x.RiskLevelId, "RiskLevel", "RiskLevelId", "ref", onDelete: ReferentialAction.Restrict); table.ForeignKey("FK_ChangeTemplate_User", x => x.CreatedBy, "User", "UserId", "cm", onDelete: ReferentialAction.Restrict); });
        migrationBuilder.CreateTable(name: "EventType", schema: "audit", columns: table => new { EventTypeId = table.Column<int>("int", nullable: false), Name = table.Column<string>("nvarchar(100)", maxLength: 100, nullable: false), Description = table.Column<string>("nvarchar(300)", maxLength: 300, nullable: true) }, constraints: table => table.PrimaryKey("PK_EventType", x => x.EventTypeId));
        migrationBuilder.Sql("INSERT INTO [audit].[EventType] (EventTypeId, Name, Description) VALUES (1,'Create','Entity created'),(2,'Update','Entity updated'),(3,'Delete','Entity soft-deleted'),(4,'ApprovalDecision','Approval status changed'),(5,'StatusChange','Change request status updated'),(6,'TaskUpdate','Task updated'),(7,'AttachmentUploaded','File attached');");
        migrationBuilder.CreateTable(name: "AuditEvent", schema: "audit", columns: table => new { AuditEventId = table.Column<Guid>("uniqueidentifier", nullable: false), EventTypeId = table.Column<int>("int", nullable: false), ActorUserId = table.Column<Guid>("uniqueidentifier", nullable: true), ActorUpn = table.Column<string>("nvarchar(256)", maxLength: 256, nullable: true), SchemaName = table.Column<string>("nvarchar(50)", maxLength: 50, nullable: true), EntityName = table.Column<string>("nvarchar(100)", maxLength: 100, nullable: true), EntityId = table.Column<Guid>("uniqueidentifier", nullable: true), EntityNumber = table.Column<string>("nvarchar(50)", maxLength: 50, nullable: true), Metadata = table.Column<string>("nvarchar(max)", nullable: true), CreatedAt = table.Column<DateTime>("datetime2", nullable: false, defaultValueSql: "GETUTCDATE()") }, constraints: table => { table.PrimaryKey("PK_AuditEvent", x => x.AuditEventId); table.ForeignKey("FK_AuditEvent_EventType", x => x.EventTypeId, "EventType", "EventTypeId", "audit", onDelete: ReferentialAction.Restrict); table.ForeignKey("FK_AuditEvent_User", x => x.ActorUserId, "User", "UserId", "cm", onDelete: ReferentialAction.Restrict); });

        // 6. ALL INDEXES (performance + uniqueness)
        migrationBuilder.CreateIndex("IX_User_Upn", "User", "Upn", schema: "cm", unique: true);
        migrationBuilder.CreateIndex("IX_ChangeRequest_ChangeNumber", "ChangeRequest", "ChangeNumber", schema: "cm", unique: true);
        migrationBuilder.CreateIndex("IX_ChangeRequest_ChangeTypeId", "ChangeRequest", "ChangeTypeId", schema: "cm");
        migrationBuilder.CreateIndex("IX_ChangeRequest_PriorityId", "ChangeRequest", "PriorityId", schema: "cm");
        migrationBuilder.CreateIndex("IX_ChangeRequest_StatusId", "ChangeRequest", "StatusId", schema: "cm");
        migrationBuilder.CreateIndex("IX_ChangeRequest_RiskLevelId", "ChangeRequest", "RiskLevelId", schema: "cm");
        migrationBuilder.CreateIndex("IX_ChangeRequest_ImpactLevelId", "ChangeRequest", "ImpactLevelId", schema: "cm");
        migrationBuilder.CreateIndex("IX_ChangeRequest_ImpactTypeId", "ChangeRequest", "ImpactTypeId", schema: "cm");
        migrationBuilder.CreateIndex("IX_ChangeRequest_RequestedByUserId", "ChangeRequest", "RequestedByUserId", schema: "cm");
        migrationBuilder.CreateIndex("IX_ChangeRequest_AssignedToUserId", "ChangeRequest", "AssignedToUserId", schema: "cm");
        migrationBuilder.CreateIndex("IX_ChangeRequest_SubmittedByUserId", "ChangeRequest", "SubmittedByUserId", schema: "cm");
        migrationBuilder.CreateIndex("IX_ChangeRequest_CreatedBy", "ChangeRequest", "CreatedBy", schema: "cm");
        migrationBuilder.CreateIndex("IX_ChangeApprover_ChangeRequestId", "ChangeApprover", "ChangeRequestId", schema: "cm");
        migrationBuilder.CreateIndex("IX_ChangeApprover_ApproverUserId", "ChangeApprover", "ApproverUserId", schema: "cm");
        migrationBuilder.CreateIndex("IX_ChangeAttachment_ChangeRequestId", "ChangeAttachment", "ChangeRequestId", schema: "cm");
        migrationBuilder.CreateIndex("IX_ChangeTask_ChangeRequestId", "ChangeTask", "ChangeRequestId", schema: "cm");
        migrationBuilder.CreateIndex("IX_ChangeTask_AssignedToUserId", "ChangeTask", "AssignedToUserId", schema: "cm");
        migrationBuilder.CreateIndex("IX_AuditEvent_EventTypeId", "AuditEvent", "EventTypeId", schema: "audit");
>>>>>>> main
    }
