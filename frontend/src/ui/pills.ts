...
export const getStatusPillClass = (status?: string): string => {
...
export const getRiskPillClass = (risk?: string): string => {
...
export const getImpactPillClass = (impact?: string): string => {
...
export const getChangeTypePillClass = (changeTypeId?: number): string => {
...
export const getChangeTypeLabel = (changeTypeId?: number): string => {
